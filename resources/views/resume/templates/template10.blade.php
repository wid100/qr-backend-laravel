        ...
        <tr>
            ...
            <td style="width: 80%; background-color: white;vertical-align: top; ">
                <div style="padding:25px 25px 0 30px; color:#000">
                    <h1 class="name-heading-6" style="color:#000"><b>Pronub</b> Shaharier</h1>
                        ...
                        <div class="left-site-bg" style="background:#989898;height:902px; padding:0px 20px 20px 20px ">
                            ...
                            <ul class="contact-list-6">
                                <li class="contact-item-6"><a href="tel:123-456-7890"
                                        class="contact-link-6" style="color: #fff">123-456-7890</a></li>
                                <li class="contact-item-6"><a href="mailto:jahanara.womeningdigital@gmail.com"
                                        class="contact-link-6" style="color: #fff">jahanara.womeningdigital@gmail.com</a></li>
                                <li class="contact-item-6" style="color: #fff">0-51, Janata Co-operative Housing Society, Mohammadpur,
                                    Dhaka,
                                    Bangladesh</li>
                            </ul>
                            <h2 class="sub-heading-6" style="color: #fff">Education</h2>
                            <ul class="education-list-6">
                                <li class="education-item-6" style="color: #fff">2008 - University of Liberal Arts Bangladesh</li>
                            </ul>
